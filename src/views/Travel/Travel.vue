<template>
  <div>
    ...
    <!-- 政策查询结果 -->
    <div class="content">
      <div class="zuihou">出发城市:</div>
      <div class="zuihou">{{from_info}}</div>
      <div class="zuihou">到达城市：</div>
      <div class="zuihou">{{to_info}}</div>
    </div>
  </div>
</template>
    ...
    search() {
      ...
      api
        ...
        .then((res) => {
          ...
          this.from_info = res.data.result.from_info.out_desc;
